...
var Local = function (_React$Component) {
  ...
  function Local() {
    ...
    var _this = _possibleConstructorReturn(this, (Local.__proto__ || Object.getPrototypeOf(Local)).call(this));
  ...
  _createClass(Local, [{
    ...
    value: function handleClick() {
      ...
      this.props.getKittens().catch(function (err) {
        _this2.setState({
...
var ConnectedLocal = (0, _reactRedux.connect)(null, { getKittens: _store.getKittens })(Local);

var FromStore = (0, _reactRedux.connect)(
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(ConnectedLocal, null),
    _react2.default.createElement(FromStore, null)
  )
...
exports.getKittens = exports.getPuppies = undefined;
...
var GOT_ERROR = 'GOT_ERROR';

var gotError = function gotError(errorMessage) {
  return {
    type: GOT_ERROR,
...
var getPuppies = exports.getPuppies = function getPuppies() {
  return function (dispatch) {
    return _axios2.default.get('/api/puppies').then(function (res) {
      return res.data;
    }).catch(function (err) {
      return dispatch(gotError(err.message));
    });
  };
};

var getKittens = exports.getKittens = function getKittens() {
  return function (dispatch) {
    return _axios2.default.get('/api/kittens').then(function (res) {
      return res.data;
    });
  };
};
...
exports.default = (0, _redux.createStore)(reducer, (0, _redux.applyMiddleware)(_reduxLogger2.default, _reduxThunk2.default));
